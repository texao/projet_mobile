...
public class connexion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("TAG", "page connexion, nom: " +  nomUtilisateur);


        Button bouton_inscription = findViewById(R.id.buttonInscription);
    ...
    public void authentification_utilisateur(String nom, String email, String nomUtilisateur, String prenomUtilisateur, String dateNaissanceUtilisateur) {
        ...
        try {
            ...
            String url = "https://192.168.1.27:8888/connexion";
                    ...
                    if (response.isSuccessful()) {
                        ...
                        try {
                            ...
                            if (authentificationReussie) {
                                ...
                                intent.putExtra("dateNaissanceUtilisateur", json.getString("dateNaissance"));


                                Log.d("TAG", "page connexion, nom envoyé: " + nomUtilisateur);
                                startActivity(intent);
                            } else {
